...
class LCATest {
	...
	public void testSameNodes(){
		...
		assertEquals("LCA of 4 and 4: ", 4, tree.functionLCA(4, 4));
	}
	...
	public void unevenTree() { 
		...
		assertEquals("LCA of 2 and 3:", 2, tree.functionLCA(2, 3));	
		assertEquals("LCA of 3 and 1:", 1, tree.functionLCA(3, 1));
	}
}
